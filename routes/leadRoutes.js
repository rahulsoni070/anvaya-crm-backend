...
const { createLead, getLeads, getLeadById, updateLead, deleteLead, getTags } = require("../controllers/leadController")
...
router.get("/leads/tags/all", authMiddleware, getTags)
